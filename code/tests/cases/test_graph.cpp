...
FOSSIL_TEST_GROUP(cpp_graph_tests) {
    FOSSIL_ADD_TEST(cpp_algorithm_graph_fixture, cpp_test_graph_supported_algorithms);
    FOSSIL_ADD_TEST(cpp_algorithm_graph_fixture, cpp_test_graph_requires_weights);
    FOSSIL_ADD_TEST(cpp_algorithm_graph_fixture, cpp_test_graph_exec_invalid_inputs);
    FOSSIL_ADD_TEST(cpp_algorithm_graph_fixture, cpp_test_graph_exec_unsupported_algorithm);
    FOSSIL_ADD_TEST(cpp_algorithm_graph_fixture, cpp_test_graph_exec_requires_weights_on_unweighted);
    FOSSIL_ADD_TEST(cpp_algorithm_graph_fixture, cpp_test_graph_exec_invalid_node_ids);
    FOSSIL_ADD_TEST(cpp_algorithm_graph_fixture, cpp_test_graph_exec_bfs_and_dfs_empty_graph);
    FOSSIL_ADD_TEST(cpp_algorithm_graph_fixture, cpp_test_graph_exec_bfs_and_dfs_null_visitor);
    FOSSIL_ADD_TEST(cpp_algorithm_graph_fixture, cpp_test_graph_exec_bfs_and_dfs_with_visitor);

    FOSSIL_ADD_SUITE(cpp_algorithm_graph_fixture);
} // end of tests
