...
FOSSIL_SUITE(c_algorithm_filter_fixture);

FOSSIL_SETUP(c_algorithm_filter_fixture) {
    // Setup the test fixture
}

FOSSIL_TEARDOWN(c_algorithm_filter_fixture) {
...
FOSSIL_TEST(c_test_filter_exec_i32_inplace_even) {
    int arr[] = {1, 2, 3, 4, 5, 6};
    int expected[] = {2, 4, 6};
    size_t out_count = 0;
...
FOSSIL_TEST(c_test_filter_exec_f64_stable_gt_threshold) {
...
FOSSIL_TEST(c_test_filter_exec_cstr_lane_compact_non_null) {
...
FOSSIL_TEST(c_test_filter_exec_bool_count_only_true) {
...
FOSSIL_TEST(c_test_filter_exec_i32_partition_even) {
    int arr[] = {1, 2, 3, 4, 5, 6};
...
FOSSIL_TEST(c_test_filter_exec_invalid_type) {
    int arr[] = {1, 2, 3};
    size_t out_count = 0;
    int status = fossil_algorithm_filter_exec(
...
FOSSIL_TEST(c_test_filter_exec_invalid_algorithm) {
    int arr[] = {1, 2, 3};
    size_t out_count = 0;
    int status = fossil_algorithm_filter_exec(
...
FOSSIL_TEST(c_test_filter_type_sizeof_supported) {
...
FOSSIL_TEST(c_test_filter_type_supported_true_false) {
...
FOSSIL_TEST(c_test_filter_exec_dry_run) {
    int arr[] = {1, 2, 3, 4, 5, 6};
    size_t out_count = 0;
    int status = fossil_algorithm_filter_exec(
...
FOSSIL_TEST(c_test_filter_exec_first_last) {
    int arr[] = {1, 3, 5, 8, 9};
    size_t out_count = 0;
