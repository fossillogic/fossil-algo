...
FOSSIL_TEST_GROUP(cpp_filter_tests) {
    FOSSIL_ADD_TEST(cpp_algorithm_filter_fixture, cpp_test_filter_exec_i32_inplace_even);
    FOSSIL_ADD_TEST(cpp_algorithm_filter_fixture, cpp_test_filter_exec_f64_stable_gt_threshold);
    FOSSIL_ADD_TEST(cpp_algorithm_filter_fixture, cpp_test_filter_exec_cstr_lane_compact_non_null);
    FOSSIL_ADD_TEST(cpp_algorithm_filter_fixture, cpp_test_filter_exec_bool_count_only_true);
    FOSSIL_ADD_TEST(cpp_algorithm_filter_fixture, cpp_test_filter_exec_i32_partition_even);
    FOSSIL_ADD_TEST(cpp_algorithm_filter_fixture, cpp_test_filter_exec_invalid_type);
    FOSSIL_ADD_TEST(cpp_algorithm_filter_fixture, cpp_test_filter_exec_invalid_algorithm);
    FOSSIL_ADD_TEST(cpp_algorithm_filter_fixture, cpp_test_filter_type_sizeof_supported);
    FOSSIL_ADD_TEST(cpp_algorithm_filter_fixture, cpp_test_filter_type_supported_true_false);
    FOSSIL_ADD_TEST(cpp_algorithm_filter_fixture, cpp_test_filter_exec_dry_run);
    FOSSIL_ADD_TEST(cpp_algorithm_filter_fixture, cpp_test_filter_exec_first_last);

    FOSSIL_ADD_SUITE(cpp_algorithm_filter_fixture);
} // end of tests
