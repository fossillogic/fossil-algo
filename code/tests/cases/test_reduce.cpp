...
FOSSIL_TEST_GROUP(cpp_reduce_tests) {
    // Reduce tests
    FOSSIL_ADD_TEST(cpp_algorithm_reduce_fixture, cpp_test_reduce_exec_i32_sum);
    FOSSIL_ADD_TEST(cpp_algorithm_reduce_fixture, cpp_test_reduce_exec_f64_min);
    FOSSIL_ADD_TEST(cpp_algorithm_reduce_fixture, cpp_test_reduce_exec_u8_max);
    FOSSIL_ADD_TEST(cpp_algorithm_reduce_fixture, cpp_test_reduce_exec_bool_any);
    FOSSIL_ADD_TEST(cpp_algorithm_reduce_fixture, cpp_test_reduce_exec_bool_all);
    FOSSIL_ADD_TEST(cpp_algorithm_reduce_fixture, cpp_test_reduce_exec_count);
    FOSSIL_ADD_TEST(cpp_algorithm_reduce_fixture, cpp_test_reduce_exec_custom_product);
    FOSSIL_ADD_TEST(cpp_algorithm_reduce_fixture, cpp_test_reduce_type_sizeof_supported);
    FOSSIL_ADD_TEST(cpp_algorithm_reduce_fixture, cpp_test_reduce_type_supported_true_false);
    FOSSIL_ADD_TEST(cpp_algorithm_reduce_fixture, cpp_test_reduce_exec_invalid_type);
    FOSSIL_ADD_TEST(cpp_algorithm_reduce_fixture, cpp_test_reduce_exec_invalid_op);
    FOSSIL_ADD_TEST(cpp_algorithm_reduce_fixture, cpp_test_reduce_exec_null_input);
    FOSSIL_ADD_TEST(cpp_algorithm_reduce_fixture, cpp_test_reduce_exec_custom_null_fn);

    FOSSIL_ADD_SUITE(cpp_algorithm_reduce_fixture);
} // end of tests
